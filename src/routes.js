...
routes.get('/noaccess/1', (req, res) => {
  ...
  res.status(200).send(createID(200, ':\\'))
})
...
routes.get('/internal', (req, res) => {
  ...
  res
    .status(200)
    .send(createID(200, "No time to stop and talk I'm late I'm late I'm late"))
})
